...
import { getSstfDiskSimulation } from '../../services/sstfDiskService';
...
const SSTFSimulator: React.FC = () => {
    ...
    const runSimulation = useCallback(() => {
        ...
        if (requests.length > 0 && startPos >= 0 && startPos < maxCylinder) {
            const simData = getSstfDiskSimulation(requests, startPos, maxCylinder);
